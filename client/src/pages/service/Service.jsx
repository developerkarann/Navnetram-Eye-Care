...
const Service = () => {
    return (
        <>
            <section className='service py-40 w-full px-3 md:px-10' id='service'>
                <div className="flex flex-col md:flex-row gap-10 items-center">
                    ...
                    <div className=" colum right md:w-[50%]">
                        <div className="content flex flex-col gap-10">
                            <h1 className="title text-3xl md:text-5xl">Leading <span className='text-blue-600'> Advanced Eye Care </span> Service in Noida </h1>
